...
class SpeedRpmGauge(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.speed_caption = self._build_label("SPEED", dp(18), (0.64, 0.72, 0.8, 1), 0.72)
        self.speed_value = self._build_label("0", dp(112), (0.98, 0.99, 1, 1), 0.56, bold=True)
        self.speed_unit = self._build_label("km/h", dp(24), (0.64, 0.72, 0.8, 1), 0.43)

        self.rpm_value = self._build_label("0 RPM", dp(24), (0.95, 0.53, 0.31, 1), 0.26, bold=True)
        self.status_label = self._build_label("Live cluster", dp(16), (0.72, 0.79, 0.88, 1), 0.15)
